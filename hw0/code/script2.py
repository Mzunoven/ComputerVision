...
# Read the image
im = imageio.imread('Computer Vision/Assignments/hw0/data/mug.jpg')
...
out_im = warpA.warp(im_gray, A, output_shape)
axes[1, 1].imshow(out_im, cmap=plt.get_cmap('gray'))
axes[1, 1].set_title('output')

# write the plot to an image
# plt.savefig('Computer Vision/Assignments/hw0/results/transformed_soln.png')
plt.show()
